...
import { CheckCircle2, MonitorDown, Trash2, X } from "lucide-vue-next";
  ...
  <Teleport to="body">
    <Transition name="menu-pop">
      <div
        ...
        class="context-menu app-no-drag fixed z-[90] w-[172px] overflow-hidden rounded-xl border border-line-2 bg-[rgba(24,31,45,0.96)] p-1 shadow-[0_14px_36px_rgba(0,0,0,0.45)] backdrop-blur-xl"
